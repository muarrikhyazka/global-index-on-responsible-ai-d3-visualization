! function(t, e) {
    ...
    function i() {
        var t = [],
            ...
            h = void 0,
            l = void 0,
            f = a.dispatch("subjectover", "subjectout", "subjectclick", "connectorover", "connectorout", "connectorclick", "noteover", "noteout", "noteclick", "dragend", "dragstart"),
            v = void 0,
            g = function(o) {
                v = o, c || o.selectAll("circle.handle").remove();
                var a = t.map(function(t) {
                    return t.type || (t.type = u), t.disable || (t.disable = i), new p(t)
                });
                n = n || new y({
                    annotations: a,
                    accessors: s,
                ...
                Q(g, n.annotations, "g", "annotation"), g.selectAll("g.annotation").each(function(t) {
                    var n = e.select(this);
                    n.attr("class", "annotation"), Q(n, [t], "g", "annotation-connector"), Q(n, [t], "g", "annotation-subject"), Q(n, [t], "g", "annotation-note"), Q(n.select("g.annotation-note"), [t], "g", "annotation-note-content"), t.type = "[object Object]" === t.type.toString() ? t.type : new t.type({
                        a: n,
                        annotation: t,
                        textWrap: h,
                        notePadding: l,
    ...
    var s = function(t, e) {
        ...
        p = function() {
            function t(e) {
                var n = e.x,
                    ...
                    j = e.id,
                    w = e.className;
                s(this, t), this._dx = void 0 !== r ? r - o : l, this._dy = void 0 !== c ? c - i : u, this._x = o, this._y = i, this._color = y, this.id = j, this._className = w || "", this.type = v || "", this.data = f, this.note = b || {}, this.connector = x || {}, this.subject = g || {}, this.disable = m || []
            }
            return r(t, [{
                key: "updatePosition",
                value: function() {
                    this.type.setPosition && (this.type.setPosition(), 0 !== this.type.subject.selectAll(":not(.handle)").nodes().length && this.type.redrawSubject())
                }
            }, {
                key: "updateOffset",
                value: function() {
        ...
        y = function() {
            function t(e) {
                ...
                s(this, t), this.accessors = o, this.accessorsInverse = a, this.annotations = n
            }
            return r(t, [{
                key: "clearTypes",
                value: function(t) {
                ...
                get: function() {
                    return this.annotations.map(function(t) {
                        return c({}, t.type.getNoteBBoxOffset(), {
                            positionX: t.x,
                            positionY: t.y
                        })
                    })
        ...
        m = ["topBottom", "top", "bottom"],
        j = ["leftRight", "left", "right"],
        w = function(t) {
            var e = t.padding,
                n = void 0 === e ? 0 : e,
                o = t.bbox,
                ...
                d = -a.x,
                u = 0;
            return m.indexOf(s) !== -1 ? (i = b(i, c.x), c.y < 0 && "topBottom" === s || "top" === s ? u -= a.height + n : u += n, "middle" === i ? d -= a.width / 2 : "right" === i && (d -= a.width)) : j.indexOf(s) !== -1 && (i = x(i, c.y), c.x < 0 && "leftRight" === s || "left" === s ? d -= a.width + n : d += n, "middle" === i ? u -= a.height / 2 : "top" === i && (u -= a.height)), {
                x: d,
                y: u
            }
        },
        ...
        M = function(t) {
            var e = t.align,
                ...
                s = t.offset,
                r = t.bbox;
            return e = b(e, s.x), "right" === e ? o -= r.width : "middle" === e && (o -= r.width / 2), {
                components: [_({
                    data: [
                        [o, i],
                        [o + r.width, i]
        ...
        S = function(t) {
            ...
            if (Math.abs(y) < Math.abs(p) ? (f = s, v = r + y * g) : (v = c, f = i + p * g), "circle" === n && (d.outerRadius || d.radius)) {
                var x = (d.outerRadius || d.radius) + (d.radiusPadding || 0),
                    b = x / Math.sqrt(2);
                if (Math.abs(y) > b && Math.abs(p) > b) i = b * (s < 0 ? -1 : 1), r = b * (c < 0 ? -1 : 1), l = [
                    [i, r],
                    [f, v],
                    [s, c]
                ];
                    ...
                    var m = Math.asin(-c / x);
                    i = Math.abs(Math.cos(m) * x) * (s < 0 ? -1 : 1), l = [
                        [i, c],
                        [s, c]
                    ]
                } else {
                    var j = Math.acos(s / x);
                    r = Math.abs(Math.sin(j) * x) * (c < 0 ? -1 : 1), l = [
                        [s, r],
                        [s, c]
                    ]
                }
        ...
        P = function(t) {
            var n = t.type,
                a = t.connectorData,
                i = t.subjectType;
            a || (a = {}), a.points && "number" != typeof a.points || (a.points = T(n.annotation.offset, a.points)), a.curve || (a.curve = o.curveCatmullRom);
            var s = [];
            if (n.editMode) {
            ...
            return u = [u[0]].concat(l(a.points), [u[1]]), {
                components: [_({
                    data: u,
                    curve: a.curve,
                    className: "connector"
        ...
        q = function(t) {
            ...
            x.attrs.transform = v, x.attrs["stroke-width"] = "3px", x.attrs.fill = "white";
            var b = void 0;
            if (l && p || !l && !p) b = _({
            ...
            if (b && (b.attrs.fill = s.color, b.attrs["stroke-linecap"] = "round", b.attrs["stroke-width"] = "3px", d.push(b)), i.editMode) {
                var j = function() {
        ...
        D = function() {
            function t(e) {
                ...
                this.annotation = o, this.editMode = o.editMode || a, this.notePadding = void 0 !== r ? r : 3, this.offsetCornerX = 0, this.offsetCornerY = 0, c && o.data && this.init(c)
            }
            return r(t, [{
                key: "init",
                value: function(t) {
                ...
                key: "getNoteBBox",
                value: function() {
                    return $(this.note, ".annotation-note-content text")
                }
            }, {
                key: "getNoteBBoxOffset",
                value: function() {
                    var t = $(this.note, ".annotation-note-content"),
                ...
                value: function() {
                    var t = this,
                        ...
                        i = {};
                    "circle" === o ? i = R(a) : "rect" === o ? i = B(a) : "threshold" === o ? i = I(a) : "badge" === o && (i = q(a, this.annotation));
                    var s = i,
                        r = s.components,
                        c = void 0 === r ? [] : r,
                        d = s.handles,
                ...
                value: function() {
                    ...
                    if ("arrow" === l) {
                        var y = h.data[1],
                            f = h.data[0];
                        Math.sqrt(Math.pow(y[0] - f[0], 2) + Math.pow(y[1] - f[1], 2)) < 5 && h.data[2] && (y = h.data[2]), p = A({
                ...
                value: function() {
                    var t = this,
                        e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        n = this.annotation.note,
                        o = n.align || e.align || "dynamic",
                        a = {
                            bbox: e.bbox,
                            align: o,
                            offset: this.annotation.offset
                        },
                        i = n.lineType || e.lineType,
                        s = {};
                    "vertical" === i ? s = O(a) : "horizontal" === i && (s = M(a));
                    var r = s,
                        c = r.components,
                        d = void 0 === c ? [] : c,
                        u = r.handles,
                    ...
                    }), this.editMode && (h = this.mapHandles([{
                        x: 0,
                        y: 0,
        ...
        W = function(t, e, n) {
            return function(t) {
                function o(t) {
                    s(this, o);
                    var n = h(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t));
                    return n.typeSettings = e, e.disable && e.disable.forEach(function(t) {
                        n[t] = void 0, "note" === t && (n.noteContent = void 0)
                    }), n
                }
                return u(o, t), r(o, [{
                    key: "className",
                    value: function() {
                        return "" + (e.className || d(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "className", this) && d(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "className", this).call(this) || "")
                    }
                }, {
                    key: "drawSubject",
                    value: function(t) {
                        return this.typeSettings.subject = c({}, e.subject, this.typeSettings.subject), d(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "drawSubject", this).call(this, c({}, t, this.typeSettings.subject))
                    }
                }, {
                    key: "drawConnector",
                    value: function(t) {
                        return this.typeSettings.connector = c({}, e.connector, this.typeSettings.connector), d(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "drawConnector", this).call(this, c({}, t, e.connector, this.typeSettings.connector))
                    }
                }, {
                    key: "drawNote",
                    value: function(t) {
                        return this.typeSettings.note = c({}, e.note, this.typeSettings.note), d(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "drawNote", this).call(this, c({}, t, e.note, this.typeSettings.note))
                    }
                }, {
                    key: "drawNoteContent",
                    value: function(t) {
                        return d(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "drawNoteContent", this).call(this, c({}, t, e.note, this.typeSettings.note))
                    }
                }], [{
                    key: "init",
                    value: function(t, e) {
                        return d(o.__proto__ || Object.getPrototypeOf(o), "init", this).call(this, t, e), n && (t = n(t, e)), t
                    }
                }]), o
            }(t)
        },
        X = function(t) {
            ...
            return u(e, t), r(e, [{
                ...
                value: function() {
                    if (this.note) {
                        Q(this.note, [this.annotation], "g", "annotation-note-content");
                        var t = this.note.select("g.annotation-note-content");
                        Q(t, [this.annotation], "rect", "annotation-note-bg"), Q(t, [this.annotation], "text", "annotation-note-label"), Q(t, [this.annotation], "text", "annotation-note-title");
                        var e = {
                                height: 0
                            },
                        ...
                        if (this.annotation.note.title) {
                            var i = this.a.select("text.annotation-note-title");
                            i.text(this.annotation.note.title), i.attr("fill", this.annotation.color), i.attr("font-weight", "bold"), i.call(Z, o, a), e = i.node().getBBox()
                        }
                        n.text(this.annotation.note.label).attr("dx", "0"), n.call(Z, o, a), n.attr("y", 1.1 * e.height || 0), n.attr("fill", this.annotation.color);
                        var s = this.getNoteBBox();
                        this.a.select("rect.annotation-note-bg").attr("width", s.width).attr("height", s.height).attr("x", s.x).attr("fill", "white").attr("fill-opacity", 0)
                    }
                }
            }]), e
        }(D),
        ...
        V = function(t) {
            function e() {
                return s(this, e), h(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments))
            }
            return u(e, t), r(e, [{
                key: "mapY",
                value: function(t) {
                    d(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "mapY", this).call(this, t);
                ...
                key: "mapX",
                value: function(t) {
                    d(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "mapX", this).call(this, t);
                    var n = this.annotation;
        ...
        tt = {
            annotation: i,
            annotationTypeBase: D,
            annotationLabel: Y,
            annotationCallout: H,
            annotationCalloutCurve: F,
            annotationCalloutElbow: z,
            annotationCalloutCircle: L,
            annotationCalloutRect: G,
            annotationXYThreshold: K,
            annotationBadge: J,
            annotationCustomType: W
        };
    t.annotation = i, t.annotationTypeBase = D, t.annotationLabel = Y, t.annotationCallout = H, t.annotationCalloutCurve = F, t.annotationCalloutElbow = z, t.annotationCalloutCircle = L, t.annotationCalloutRect = G, t.annotationXYThreshold = K, t.annotationBadge = J, t.annotationCustomType = W, t.default = tt, Object.defineProperty(t, "__esModule", {
        value: !0
    })
});